...
from App.facerecognition import Recognizer
...
recognizer = Recognizer(
    socketio=socketio,
    facerecognition_model = os.path.join(PATH, "App\\src\\frozen_graph.pb"), 
    labels_filename=os.path.join(PATH, "App\\labels.csv"), 
    facedetection_model=os.path.join(PATH, "App\\src\\haarcascade_frontalface_default.xml"),
    use_mtcnn = False,
    camera_src=0
)
